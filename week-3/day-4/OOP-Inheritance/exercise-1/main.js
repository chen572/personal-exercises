...
class Principal extends Person {
    ...
    recruitStudent = (student) => this.students.push(student);

    expelStudent = (student) => this.students.splice(this.students.indexOf(student), 1);

    transferStudent = (student, principal) => principal.students.push(this.expelStudent(student)[0]);
}
