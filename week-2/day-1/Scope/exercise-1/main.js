...
if (run) {
    ...
    console.log("Finished running " + distance + " miles")  // WORKS
}
...
const serveOrders = function (orders) {
    ...
    for (let order of orders) {
        let specialOrder = "special " + order   // WORKS
        console.log("Served a " + specialOrder)     // WORKS
    }
...
makeEnough()
if (isEnough) {                         // WILL WORK BUT ONLY GONNA BE FALSE ALWAYS
